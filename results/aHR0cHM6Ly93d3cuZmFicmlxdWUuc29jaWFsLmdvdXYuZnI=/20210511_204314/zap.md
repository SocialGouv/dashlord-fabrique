...
Generated on Tue, 11 May 2021 20:37:44
...
* URL: [https://www.fabrique.social.gouv.fr/sitemap.xml](https://www.fabrique.social.gouv.fr/sitemap.xml)
  ...
  * Evidence: `default-src 'none'; connect-src 'self' https://matomo.fabrique.social.gouv.fr/piwik.php; font-src 'self'; img-src 'self'; script-src 'self' https://matomo.fabrique.social.gouv.fr/piwik.js; style-src 'self' 'unsafe-inline'`
...
* URL: [https://www.fabrique.social.gouv.fr/startups/monsuivipsy/](https://www.fabrique.social.gouv.fr/startups/monsuivipsy/)
  
  
  * Method: `GET`
  
  
  * Evidence: `<a class="article__author-name" target="_blank" href="https://github.com/SocialGouv/monsuivipsy">Github</a>`
...
### Other information
<p>The following pattern was used: \bQUERY\b and was detected in the element starting with: "<script id="__NEXT_DATA__" type="application/json">{"props":{"pageProps":{}},"page":"/idees","query":{},"buildId":"YhFjCfmHQnOwm", see evidence field for the suspicious comment/snippet.</p>
